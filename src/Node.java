...
/**
 * List element in the Priority Queue, stores a letter and frequency of the letter
 * and is repurposed as leafs in the huffman tree later on.
 * @author Cory Johns
 * @version 01.27.2018
 */
public class Node implements Comparator<Node> {
	 ...
	 * Prints the node's descriptive information to the given writer
	 * @param writer
	 * @param print_null_nodes will not print nodes with letter values of '\0' if false
	 * @throws IOException
	 */
