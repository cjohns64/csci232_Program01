...
public class Tree {
    ...
    public void rotateParentleft(Node currentParent){

    }
    public void rotateParentright(Node currentParent){

    }
    public void leftRotateChild(Node currentParent) {
    ...
    public void rightRotateChild(Node currentParent) {/*
